      ...
      <div className='bg-white w-full max-w-4xl mx-auto mt-4 p-6 rounded-md shadow-md flex-1'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <div className='flex flex-col sm:flex-row justify-center gap-4 px-4'>
            <input type='text' placeholder='First Name' className='bg-[#B6CBBD] px-6 py-3 rounded-sm w-full sm:w-1/2' />
            <input type='text' placeholder='Last Name' className='bg-[#B6CBBD] px-6 py-3 rounded-sm w-full sm:w-1/2' />
          </div>

          <div className='flex flex-col sm:flex-row justify-center gap-4 px-4'>
            <input type='password' placeholder='Password' className='bg-[#B6CBBD] px-6 py-3 rounded-sm w-full sm:w-1/2' />
            <input type='password' placeholder='Confirm Password' className='bg-[#B6CBBD] px-6 py-3 rounded-sm w-full sm:w-1/2' />
          </div>

          <div className='flex justify-center px-4'>
            <input type='email' placeholder='Email mail@site.com' className='bg-[#B6CBBD] px-6 py-3 rounded-sm w-full sm:w-2/3' />
          </div>
          ...
          <div className='flex justify-center px-4'>
            <button type='submit' className='bg-[#6D2323] text-white px-6 py-3 rounded-sm w-full sm:w-2/3 mt-4'>
              Sign Up
            </button>
          </div>
